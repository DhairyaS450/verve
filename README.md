...
## Roleplay prep (DECA / FBLA)

A separate track at `/roleplay`: 102 real cases (90 DECA district sample events across every Principles, Individual Series, Team Decision Making and Personal Financial Literacy event; 12 FBLA sample cases), official clocks (DECA 10 / 10, team 30 / 15; FBLA 20 / 7 with judges interrupting), a prep pad, an indicator checklist while you talk, judge questions at the right moment, and Vero scoring on the actual evaluation forms (DECA 14-point indicators and 21st Century Skills, the 2026 Principles and Team forms, FBLA rating sheets). Paste any official PDF to practise your own case. Sources and rubrics are in [`docs/RESEARCH.md`](docs/RESEARCH.md); the case JSON is generated by `scripts/build-cases.mjs`.
